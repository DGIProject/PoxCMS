...
<br>
    ...
    <br>
        <div id="page"
             style="width: auto;height: 50%;padding: 10px 10px 10px 10px; display: none;overflow : auto;border-width:2px 2px 2px 2px; border-style:solid dashed;border-color: #4169e1">
    ...
    <form action="del_exe.php" method="post">
        ...
        <input type="submit" value="Suprimer !" name="surpime" align="left"
               onclick=" return confirm('Etes vous sur de votre action ? Celle-ci est irreversible !')"><input
            type="reset" value="NON !" onclick="document.location.href = 'admin.php';" align="right">
    </form>
<?php
}
