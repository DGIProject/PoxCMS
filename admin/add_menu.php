...
<p>
    <br/><br/>
    depuis cette page vous pouvez ajouter des menu a votre site web , en plus de pouvoir en ajouter vous pouvez les
    positionner et les modifier en fonction des template:
    <br/>
    pour commencer il vous dait choisir un tire pour le menu, celui ci ne sera pas affiche lais servira de desvription.
    purement de repere dans la liste des menu si vous en avez plusieurs.

<form method="post" action="save_menu.php">
    <label for="title">Titre ou courte description :</label><input id="title" type="text" name="title_post"
                                                                   value=""/><br>
    <label for="positi">postition dans la page</label><select name="posit" id="positi">
    <option>Haut</option>
