            ...
            <div class="span12">
                ...
                {?>
                    ...
                    <form method="post" action="" onsubmit="signin(this.action.value,this.hote.value,this.ident.value, this.psw.value, this.bdd.value);return false" name="bdd">
                        ...
                        <input type="submit" class="btn btn-info" value="test de connection" onclick="javascript:document.getElementById('msg3').style.display='';document.getElementById('ok').style.display='none';document.getElementById('erreur').style.display='none';">
                        <br>
                        ...
                        <div id="msg3" style="display: none;"><img src="../images/loading4.gif"></div><br>
                    </form>
                    <form method="post" action="?e=3">
                        <input type="submit" class="btn btn-primary" value="suivant" id="suivant" disabled="disabled" name="suivant"><input type="button" class="btn" onclick="document.location.href='index.php?e=1'" value="precedant"><br>
                    </form>
                ...
                {?>
                    ...
                    <input type="submit" class="btn btn-primary" value="Installer les données de base" onclick="javascript:document.getElementById('msg31').style.display='';document.getElementById('ok1').style.display='none';document.getElementById('erreur1').style.display='none';">
                </form>
                    ...
                    <form action="?e=4" method="post"><input type="submit" class="btn btn-primary" value="suivant" name="suiv" id="suiva" disabled="disabled"><input type="button" name="prec" class="btn" value="précedant" onclick="document.location.href='index.php?e=2'"></form>
                ...
                {?>
                    ...
                    <form action="save_ident.php" method="post">
                        ...
                        <br><br><input type="submit" class="btn-primary btn" name="sub"id="subscribadm" value="crer les identifiant">
                    </form>
